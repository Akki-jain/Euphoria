...
<head>
  ...
  <body>
    <div class="topnav">
        ...
        <a class="nav-link" href="cart.php"><img src="icons/cart.svg" height="50" width="70" class="cart"><p id="cart-item" style="margin-top:-50px; margin-left:200px; background-color: #ca1f08; color: #ffffff; border-radius: 5px;" class="badge badge-danger"></p></a>
